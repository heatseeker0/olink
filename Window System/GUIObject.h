...
#pragma mark Getters & Setters
        ...
        void setCoordinates(Zeni::Point2f newCoords) __attribute__ ((deprecated)); //Set the coord variable.  You should probably use moveTo for more clarity but it's there as a generic setter
        
        std::string getUID();
        
#pragma mark movement methods
        
        void transform(Zeni::Point2f coordToMoveBy); //Move the position by this amount        
        void moveTo(Zeni::Point2f coordToMoveTo); //Set the object's cords to this
        
#pragma mark render methods
        
        virtual void render(); //Every sub class needs to have a render method!
        virtual void renderAt(Zeni::Point2f coord); //Render method to render at a specific point, used for adjusting if for example the object is in a window
